        ...
        <MessageScreen>
            <div className="mx-auto max-w-md w-full border border-[#1A1A18] dark:border-[#EDECE6] bg-[#EBEAE3] dark:bg-[#141412] px-6 sm:px-10 py-10 text-center flex flex-col items-center">
                ...
                <SignOutButton redirectUrl="/">
                    <button className="group inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#1A1A18] hover:bg-[#C1440E] dark:bg-[#EDECE6] dark:text-[#141412] dark:hover:bg-[#E0662B] text-white text-sm uppercase tracking-wide transition-colors">
