...
interface BuyersSkeletonProps {
    rows?: number
}

export function BuyersSkeleton({ rows = 8 }: BuyersSkeletonProps) {
    return (
        <div className="space-y-6">
            ...
            <div className="border border-[#D3D2C9] dark:border-[#2A2A26] bg-[#EBEAE3] dark:bg-[#141412]">
                {/* mobile — calca buyer-mobile-list.tsx */}
                ...
                {/* desktop — calca buyers-table.tsx */}
